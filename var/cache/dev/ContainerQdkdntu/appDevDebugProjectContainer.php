...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array(), $containerDir = __DIR__)
    {
        ...
        $this->normalizedIds = array(
            ...
            'sonata\\pagebundle\\command\\cleanupsnapshotscommand' => 'Sonata\\PageBundle\\Command\\CleanupSnapshotsCommand',
            'sonata\\pagebundle\\command\\clonesitecommand' => 'Sonata\\PageBundle\\Command\\CloneSiteCommand',
            'sonata\\pagebundle\\command\\createblockcontainercommand' => 'Sonata\\PageBundle\\Command\\CreateBlockContainerCommand',
            'sonata\\pagebundle\\command\\createsitecommand' => 'Sonata\\PageBundle\\Command\\CreateSiteCommand',
            'sonata\\pagebundle\\command\\createsnapshotscommand' => 'Sonata\\PageBundle\\Command\\CreateSnapshotsCommand',
            'sonata\\pagebundle\\command\\dumppagecommand' => 'Sonata\\PageBundle\\Command\\DumpPageCommand',
            'sonata\\pagebundle\\command\\migrateblocknamesettingcommand' => 'Sonata\\PageBundle\\Command\\MigrateBlockNameSettingCommand',
            'sonata\\pagebundle\\command\\migratetojsontypecommand' => 'Sonata\\PageBundle\\Command\\MigrateToJsonTypeCommand',
            'sonata\\pagebundle\\command\\renderblockcommand' => 'Sonata\\PageBundle\\Command\\RenderBlockCommand',
            'sonata\\pagebundle\\command\\updatecoreroutescommand' => 'Sonata\\PageBundle\\Command\\UpdateCoreRoutesCommand',
        ...
        $this->fileMap = array(
            ...
            'Sonata\\PageBundle\\Command\\CleanupSnapshotsCommand' => 'getCleanupSnapshotsCommandService.php',
            'Sonata\\PageBundle\\Command\\CloneSiteCommand' => 'getCloneSiteCommandService.php',
            'Sonata\\PageBundle\\Command\\CreateBlockContainerCommand' => 'getCreateBlockContainerCommandService.php',
            'Sonata\\PageBundle\\Command\\CreateSiteCommand' => 'getCreateSiteCommandService.php',
            'Sonata\\PageBundle\\Command\\CreateSnapshotsCommand' => 'getCreateSnapshotsCommandService.php',
            'Sonata\\PageBundle\\Command\\DumpPageCommand' => 'getDumpPageCommandService.php',
            'Sonata\\PageBundle\\Command\\MigrateBlockNameSettingCommand' => 'getMigrateBlockNameSettingCommandService.php',
            'Sonata\\PageBundle\\Command\\MigrateToJsonTypeCommand' => 'getMigrateToJsonTypeCommandService.php',
            'Sonata\\PageBundle\\Command\\RenderBlockCommand' => 'getRenderBlockCommandService.php',
            'Sonata\\PageBundle\\Command\\UpdateCoreRoutesCommand' => 'getUpdateCoreRoutesCommandService.php',
            ...
            'sonata.cache.orm.event_subscriber' => 'getSonata_Cache_Orm_EventSubscriberService.php',
            ...
            'sonata.page.admin.block.template_registry' => 'getSonata_Page_Admin_Block_TemplateRegistryService.php',
            'sonata.page.admin.page.template_registry' => 'getSonata_Page_Admin_Page_TemplateRegistryService.php',
            'sonata.page.admin.shared_block.template_registry' => 'getSonata_Page_Admin_SharedBlock_TemplateRegistryService.php',
            'sonata.page.admin.site.template_registry' => 'getSonata_Page_Admin_Site_TemplateRegistryService.php',
            'sonata.page.admin.snapshot.template_registry' => 'getSonata_Page_Admin_Snapshot_TemplateRegistryService.php',
            'sonata.page.block.ajax' => 'getSonata_Page_Block_AjaxService.php',
            'sonata.page.block.breadcrumb' => 'getSonata_Page_Block_BreadcrumbService.php',
            'sonata.page.block.children_pages' => 'getSonata_Page_Block_ChildrenPagesService.php',
            'sonata.page.block.container' => 'getSonata_Page_Block_ContainerService.php',
            'sonata.page.block.pagelist' => 'getSonata_Page_Block_PagelistService.php',
            'sonata.page.block.shared_block' => 'getSonata_Page_Block_SharedBlockService.php',
            'sonata.page.block_interactor' => 'getSonata_Page_BlockInteractorService.php',
            'sonata.page.cms.page' => 'getSonata_Page_Cms_PageService.php',
            'sonata.page.cms.snapshot' => 'getSonata_Page_Cms_SnapshotService.php',
            'sonata.page.form.create_snapshot' => 'getSonata_Page_Form_CreateSnapshotService.php',
            'sonata.page.form.page_type_choice' => 'getSonata_Page_Form_PageTypeChoiceService.php',
            'sonata.page.form.template_choice' => 'getSonata_Page_Form_TemplateChoiceService.php',
            'sonata.page.form.type.page_selector' => 'getSonata_Page_Form_Type_PageSelectorService.php',
            'sonata.page.kernel.exception_listener' => 'getSonata_Page_Kernel_ExceptionListenerService.php',
            'sonata.page.manager.block' => 'getSonata_Page_Manager_BlockService.php',
            'sonata.page.manager.page' => 'getSonata_Page_Manager_PageService.php',
            'sonata.page.manager.snapshot' => 'getSonata_Page_Manager_SnapshotService.php',
            'sonata.page.notification.cleanup_snapshot' => 'getSonata_Page_Notification_CleanupSnapshotService.php',
            'sonata.page.notification.cleanup_snapshots' => 'getSonata_Page_Notification_CleanupSnapshotsService.php',
            'sonata.page.notification.create_snapshot' => 'getSonata_Page_Notification_CreateSnapshotService.php',
            'sonata.page.notification.create_snapshots' => 'getSonata_Page_Notification_CreateSnapshotsService.php',
            'sonata.page.proxy.snapshot.factory' => 'getSonata_Page_Proxy_Snapshot_FactoryService.php',
            'sonata.page.route.page.generator' => 'getSonata_Page_Route_Page_GeneratorService.php',
            'sonata.page.router' => 'getSonata_Page_RouterService.php',
            'sonata.page.transformer' => 'getSonata_Page_TransformerService.php',
            'sonata.page.validator.unique_url' => 'getSonata_Page_Validator_UniqueUrlService.php',
        ...
        $this->privates = array(
            ...
            'sonata.notification.consumer.metadata' => true,
            'sonata.notification.dispatcher' => true,
            'sonata.page.block.ajax' => true,
            'sonata.page.block.context_manager' => true,
            'sonata.page.cache.js_async' => true,
            'sonata.page.cache.js_sync' => true,
            'sonata.page.decorator_strategy' => true,
            'sonata.page.form.create_snapshot' => true,
            'sonata.page.form.page_type_choice' => true,
            'sonata.page.form.template_choice' => true,
            'sonata.page.form.type.page_selector' => true,
            'sonata.page.kernel.exception_listener' => true,
            'sonata.page.request_listener' => true,
            'sonata.page.response_listener' => true,
            'sonata.page.site.selector.host' => true,
            'sonata.page.twig.global' => true,
            'sonata.page.validator.unique_url' => true,
        ...
        $this->privates['service_container'] = function () {
            ...
            include_once $this->targetDirs[3].'\\vendor\\sonata-project\\page-bundle\\src\\Twig\\Extension\\PageExtension.php';
            ...
            include_once $this->targetDirs[3].'\\vendor\\sonata-project\\page-bundle\\src\\Site\\SiteSelectorInterface.php';
            include_once $this->targetDirs[3].'\\vendor\\sonata-project\\page-bundle\\src\\Site\\BaseSiteSelector.php';
            include_once $this->targetDirs[3].'\\vendor\\sonata-project\\page-bundle\\src\\Site\\HostSiteSelector.php';
            include_once $this->targetDirs[3].'\\vendor\\sonata-project\\page-bundle\\src\\Listener\\ResponseListener.php';
            include_once $this->targetDirs[3].'\\vendor\\sonata-project\\page-bundle\\src\\Listener\\RequestListener.php';
            include_once $this->targetDirs[3].'\\vendor\\sonata-project\\page-bundle\\src\\CmsManager\\CmsManagerSelectorInterface.php';
            ...
            include_once $this->targetDirs[3].'\\vendor\\sonata-project\\page-bundle\\src\\CmsManager\\CmsManagerSelector.php';
            include_once $this->targetDirs[3].'\\vendor\\sonata-project\\page-bundle\\src\\CmsManager\\DecoratorStrategyInterface.php';
            include_once $this->targetDirs[3].'\\vendor\\sonata-project\\page-bundle\\src\\CmsManager\\DecoratorStrategy.php';
            include_once $this->targetDirs[3].'\\vendor\\sonata-project\\page-bundle\\src\\Model\\Template.php';
            include_once $this->targetDirs[3].'\\vendor\\sonata-project\\page-bundle\\src\\Page\\TemplateManagerInterface.php';
            include_once $this->targetDirs[3].'\\vendor\\sonata-project\\page-bundle\\src\\Page\\TemplateManager.php';
            include_once $this->targetDirs[3].'\\vendor\\sonata-project\\page-bundle\\src\\Page\\PageServiceManagerInterface.php';
            include_once $this->targetDirs[3].'\\vendor\\sonata-project\\page-bundle\\src\\Page\\PageServiceManager.php';
            include_once $this->targetDirs[3].'\\vendor\\sonata-project\\page-bundle\\src\\Page\\Service\\PageServiceInterface.php';
            include_once $this->targetDirs[3].'\\vendor\\sonata-project\\page-bundle\\src\\Page\\Service\\BasePageService.php';
            include_once $this->targetDirs[3].'\\vendor\\sonata-project\\page-bundle\\src\\Page\\Service\\DefaultPageService.php';
            ...
            include_once $this->targetDirs[3].'\\vendor\\sonata-project\\page-bundle\\src\\Block\\BlockContextManager.php';
            ...
            include_once $this->targetDirs[3].'\\vendor\\sonata-project\\page-bundle\\src\\Model\\SiteManagerInterface.php';
            include_once $this->targetDirs[3].'\\vendor\\sonata-project\\page-bundle\\src\\Entity\\SiteManager.php';
            include_once $this->targetDirs[3].'\\vendor\\sonata-project\\cache\\src\\CacheAdapterInterface.php';
            include_once $this->targetDirs[3].'\\vendor\\sonata-project\\page-bundle\\src\\Cache\\BlockJsCache.php';
            include_once $this->targetDirs[3].'\\vendor\\sonata-project\\page-bundle\\src\\Twig\\GlobalVariables.php';
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('6NnZ+6zoXB', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('4HPZ2LNPca', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        $this->services['sonata.admin.pool'] = $instance = new \Sonata\AdminBundle\Admin\Pool($this, 'Sonata Admin', 'bundles/sonataadmin/logo_title.png', array('html5_validate' => true, 'lock_protection' => false, 'enable_jms_di_extra_autoregistration' => true, 'sort_admins' => false, 'confirm_exit' => true, 'use_select2' => true, 'use_icheck' => true, 'use_bootlint' => false, 'use_stickyforms' => true, 'pager_links' => NULL, 'form_type' => 'standard', 'dropdown_number_groups_per_colums' => 2, 'title_mode' => 'both', 'javascripts' => array(0 => 'bundles/sonatacore/vendor/jquery/dist/jquery.min.js', 1 => 'bundles/sonataadmin/vendor/jquery.scrollTo/jquery.scrollTo.min.js', 2 => 'bundles/sonatacore/vendor/moment/min/moment.min.js', 3 => 'bundles/sonataadmin/vendor/jqueryui/ui/minified/jquery-ui.min.js', 4 => 'bundles/sonataadmin/vendor/jqueryui/ui/minified/i18n/jquery-ui-i18n.min.js', 5 => 'bundles/sonatacore/vendor/bootstrap/dist/js/bootstrap.min.js', 6 => 'bundles/sonatacore/vendor/eonasdan-bootstrap-datetimepicker/build/js/bootstrap-datetimepicker.min.js', 7 => 'bundles/sonataadmin/vendor/jquery-form/jquery.form.js', 8 => 'bundles/sonataadmin/jquery/jquery.confirmExit.js', 9 => 'bundles/sonataadmin/vendor/x-editable/dist/bootstrap3-editable/js/bootstrap-editable.min.js', 10 => 'bundles/sonatacore/vendor/select2/select2.min.js', 11 => 'bundles/sonataadmin/vendor/admin-lte/dist/js/app.min.js', 12 => 'bundles/sonataadmin/vendor/iCheck/icheck.min.js', 13 => 'bundles/sonataadmin/vendor/slimScroll/jquery.slimscroll.min.js', 14 => 'bundles/sonataadmin/vendor/waypoints/lib/jquery.waypoints.min.js', 15 => 'bundles/sonataadmin/vendor/waypoints/lib/shortcuts/sticky.min.js', 16 => 'bundles/sonataadmin/Admin.js', 17 => 'bundles/sonataadmin/treeview.js', 18 => 'bundles/sonataadmin/sidebar.js', 19 => 'bundles/sonatapage/sonata-page.back.min.js'), 'stylesheets' => array(0 => 'bundles/sonatacore/vendor/bootstrap/dist/css/bootstrap.min.css', 1 => 'bundles/sonatacore/vendor/components-font-awesome/css/font-awesome.min.css', 2 => 'bundles/sonatacore/vendor/ionicons/css/ionicons.min.css', 3 => 'bundles/sonataadmin/vendor/admin-lte/dist/css/AdminLTE.min.css', 4 => 'bundles/sonataadmin/vendor/admin-lte/dist/css/skins/skin-black.min.css', 5 => 'bundles/sonataadmin/vendor/iCheck/skins/square/blue.css', 6 => 'bundles/sonatacore/vendor/eonasdan-bootstrap-datetimepicker/build/css/bootstrap-datetimepicker.min.css', 7 => 'bundles/sonataadmin/vendor/jqueryui/themes/base/jquery-ui.css', 8 => 'bundles/sonatacore/vendor/select2/select2.css', 9 => 'bundles/sonatacore/vendor/select2-bootstrap-css/select2-bootstrap.min.css', 10 => 'bundles/sonataadmin/vendor/x-editable/dist/bootstrap3-editable/css/bootstrap-editable.css', 11 => 'bundles/sonataadmin/css/styles.css', 12 => 'bundles/sonataadmin/css/layout.css', 13 => 'bundles/sonataadmin/css/tree.css', 14 => 'bundles/sonataadmin/css/colors.css', 15 => 'bundles/sonatapage/sonata-page.back.min.css'), 'role_admin' => 'ROLE_ADMIN', 'role_super_admin' => 'ROLE_SUPER_ADMIN', 'search' => true), ${($_ = isset($this->services['property_accessor']) ? $this->services['property_accessor'] : $this->getPropertyAccessorService()) && false ?: '_'});
        ...
        $instance->setAdminServiceIds(array(0 => 'sonata.user.admin.user', 1 => 'sonata.user.admin.group', 2 => 'sonata.page.admin.page', 3 => 'sonata.page.admin.block', 4 => 'sonata.page.admin.shared_block', 5 => 'sonata.page.admin.snapshot', 6 => 'sonata.page.admin.site'));
        $instance->setAdminGroups(array('sonata_user' => array('label' => 'sonata_user', 'label_catalogue' => 'SonataUserBundle', 'icon' => '<i class=\'fa fa-users\'></i>', 'roles' => array(), 'on_top' => false, 'keep_open' => false, 'items' => array(0 => array('admin' => 'sonata.user.admin.user', 'label' => 'users', 'route' => '', 'route_params' => array(), 'route_absolute' => false), 1 => array('admin' => 'sonata.user.admin.group', 'label' => 'groups', 'route' => '', 'route_params' => array(), 'route_absolute' => false))), 'sonata_page' => array('label' => 'sonata_page', 'label_catalogue' => 'SonataPageBundle', 'icon' => '<i class="fa fa-folder"></i>', 'roles' => array(), 'on_top' => false, 'keep_open' => false, 'items' => array(0 => array('admin' => 'sonata.page.admin.page', 'label' => 'page', 'route' => '', 'route_params' => array(), 'route_absolute' => false), 1 => array('admin' => 'sonata.page.admin.shared_block', 'label' => 'shared_block', 'route' => '', 'route_params' => array(), 'route_absolute' => false), 2 => array('admin' => 'sonata.page.admin.site', 'label' => 'site', 'route' => '', 'route_params' => array(), 'route_absolute' => false)))));
        $instance->setAdminClasses(array('Application\\Sonata\\UserBundle\\Entity\\User' => array(0 => 'sonata.user.admin.user'), 'Application\\Sonata\\UserBundle\\Entity\\Group' => array(0 => 'sonata.user.admin.group'), 'Application\\Sonata\\PageBundle\\Entity\\Page' => array(0 => 'sonata.page.admin.page'), 'Application\\Sonata\\PageBundle\\Entity\\Block' => array(0 => 'sonata.page.admin.block', 1 => 'sonata.page.admin.shared_block'), 'Application\\Sonata\\PageBundle\\Entity\\Snapshot' => array(0 => 'sonata.page.admin.snapshot'), 'Application\\Sonata\\PageBundle\\Entity\\Site' => array(0 => 'sonata.page.admin.site')));
    ...
    protected function getSonata_Page_Admin_BlockService()
    {
        ...
        include_once $this->targetDirs[3].'\\vendor\\sonata-project\\page-bundle\\src\\Admin\\BaseBlockAdmin.php';
        include_once $this->targetDirs[3].'\\vendor\\sonata-project\\page-bundle\\src\\Admin\\BlockAdmin.php';
        ...
        $instance = new \Sonata\PageBundle\Admin\BlockAdmin('sonata.page.admin.block', 'Application\\Sonata\\PageBundle\\Entity\\Block', 'SonataPageBundle:BlockAdmin', $this->parameters['sonata_block.blocks']);

        $instance->setCacheManager(${($_ = isset($this->services['sonata.cache.manager']) ? $this->services['sonata.cache.manager'] : $this->getSonata_Cache_ManagerService()) && false ?: '_'});
        $instance->setBlockManager(${($_ = isset($this->services['sonata.block.manager']) ? $this->services['sonata.block.manager'] : $this->getSonata_Block_ManagerService()) && false ?: '_'});
        $instance->setTranslationDomain('SonataPageBundle');
        $instance->setContainerBlockTypes($this->parameters['sonata.block.container.types']);
        $instance->setFormTheme(array(0 => '@SonataPage/Form/form_admin_fields.html.twig', 1 => '@SonataDoctrineORMAdmin/Form/form_admin_fields.html.twig'));
        ...
        $instance->setTemplateRegistry(${($_ = isset($this->services['sonata.page.admin.block.template_registry']) ? $this->services['sonata.page.admin.block.template_registry'] : $this->load('getSonata_Page_Admin_Block_TemplateRegistryService.php')) && false ?: '_'});
    ...
    protected function getSonata_Page_Admin_PageService()
    {
        ...
        include_once $this->targetDirs[3].'\\vendor\\sonata-project\\page-bundle\\src\\Admin\\BaseBlockAdmin.php';
        include_once $this->targetDirs[3].'\\vendor\\sonata-project\\page-bundle\\src\\Admin\\BlockAdmin.php';
        include_once $this->targetDirs[3].'\\vendor\\sonata-project\\page-bundle\\src\\Admin\\SnapshotAdmin.php';
        include_once $this->targetDirs[3].'\\vendor\\sonata-project\\page-bundle\\src\\Admin\\PageAdmin.php';
        include_once $this->targetDirs[3].'\\vendor\\sonata-project\\admin-bundle\\src\\Translator\\LabelTranslatorStrategyInterface.php';
        include_once $this->targetDirs[3].'\\vendor\\sonata-project\\admin-bundle\\src\\Translator\\UnderscoreLabelTranslatorStrategy.php';
        include_once $this->targetDirs[3].'\\vendor\\sonata-project\\admin-bundle\\src\\Security\\Handler\\SecurityHandlerInterface.php';
        include_once $this->targetDirs[3].'\\vendor\\sonata-project\\admin-bundle\\src\\Security\\Handler\\NoopSecurityHandler.php';
        ...
        $a = ${($_ = isset($this->services['sonata.cache.manager']) ? $this->services['sonata.cache.manager'] : $this->getSonata_Cache_ManagerService()) && false ?: '_'};
        ...
        $p = new \Sonata\PageBundle\Admin\BlockAdmin('sonata.page.admin.block', 'Application\\Sonata\\PageBundle\\Entity\\Block', 'SonataPageBundle:BlockAdmin', $this->parameters['sonata_block.blocks']);
        $p->setCacheManager($a);
        $p->setBlockManager(${($_ = isset($this->services['sonata.block.manager']) ? $this->services['sonata.block.manager'] : $this->getSonata_Block_ManagerService()) && false ?: '_'});
        $p->setTranslationDomain('SonataPageBundle');
        $p->setContainerBlockTypes($this->parameters['sonata.block.container.types']);
        $p->setFormTheme(array(0 => '@SonataPage/Form/form_admin_fields.html.twig', 1 => '@SonataDoctrineORMAdmin/Form/form_admin_fields.html.twig'));
        ...
        $p->setTemplateRegistry(${($_ = isset($this->services['sonata.page.admin.block.template_registry']) ? $this->services['sonata.page.admin.block.template_registry'] : $this->load('getSonata_Page_Admin_Block_TemplateRegistryService.php')) && false ?: '_'});
        $p->setSecurityInformation($this->parameters['sonata.admin.configuration.security.information']);
        $p->initialize();
        $p->addExtension($o);
        ...
        $q->setTemplateRegistry(${($_ = isset($this->services['sonata.page.admin.snapshot.template_registry']) ? $this->services['sonata.page.admin.snapshot.template_registry'] : $this->load('getSonata_Page_Admin_Snapshot_TemplateRegistryService.php')) && false ?: '_'});
        $q->setSecurityInformation($this->parameters['sonata.admin.configuration.security.information']);
        $q->initialize();
        $q->addExtension($o);

        $instance->addChild($p, 'page');
        $instance->addChild($q, 'page');
        $instance->setPageManager(${($_ = isset($this->services['sonata.page.manager.page']) ? $this->services['sonata.page.manager.page'] : $this->load('getSonata_Page_Manager_PageService.php')) && false ?: '_'});
        $instance->setCacheManager($a);
        $instance->setSiteManager(${($_ = isset($this->services['sonata.page.manager.site']) ? $this->services['sonata.page.manager.site'] : $this->getSonata_Page_Manager_SiteService()) && false ?: '_'});
        $instance->setTranslationDomain('SonataPageBundle');
        ...
        $instance->showMosaicButton(true);
        $instance->setTemplateRegistry(${($_ = isset($this->services['sonata.page.admin.page.template_registry']) ? $this->services['sonata.page.admin.page.template_registry'] : $this->load('getSonata_Page_Admin_Page_TemplateRegistryService.php')) && false ?: '_'});
        $instance->setSecurityInformation($this->parameters['sonata.admin.configuration.security.information']);
        $instance->initialize();
    ...
    protected function getSonata_Page_Admin_SharedBlockService()
    {
        ...
        include_once $this->targetDirs[3].'\\vendor\\sonata-project\\admin-bundle\\src\\Admin\\AbstractAdmin.php';
        include_once $this->targetDirs[3].'\\vendor\\sonata-project\\page-bundle\\src\\Admin\\BaseBlockAdmin.php';
        include_once $this->targetDirs[3].'\\vendor\\sonata-project\\page-bundle\\src\\Admin\\SharedBlockAdmin.php';
        include_once $this->targetDirs[3].'\\vendor\\sonata-project\\admin-bundle\\src\\Translator\\LabelTranslatorStrategyInterface.php';
        include_once $this->targetDirs[3].'\\vendor\\sonata-project\\admin-bundle\\src\\Translator\\UnderscoreLabelTranslatorStrategy.php';
        include_once $this->targetDirs[3].'\\vendor\\sonata-project\\admin-bundle\\src\\Security\\Handler\\SecurityHandlerInterface.php';
        include_once $this->targetDirs[3].'\\vendor\\sonata-project\\admin-bundle\\src\\Security\\Handler\\NoopSecurityHandler.php';
        ...
        $instance->showMosaicButton(true);
        $instance->setTemplateRegistry(${($_ = isset($this->services['sonata.page.admin.shared_block.template_registry']) ? $this->services['sonata.page.admin.shared_block.template_registry'] : $this->load('getSonata_Page_Admin_SharedBlock_TemplateRegistryService.php')) && false ?: '_'});
        $instance->setSecurityInformation($this->parameters['sonata.admin.configuration.security.information']);
        $instance->initialize();
        $instance->addExtension(${($_ = isset($this->services['sonata.admin.event.extension']) ? $this->services['sonata.admin.event.extension'] : $this->load('getSonata_Admin_Event_ExtensionService.php')) && false ?: '_'});
    ...
    protected function getSonata_Page_Admin_SiteService()
    {
        ...
        include_once $this->targetDirs[3].'\\vendor\\sonata-project\\admin-bundle\\src\\Admin\\AdminTreeInterface.php';
        include_once $this->targetDirs[3].'\\vendor\\sonata-project\\admin-bundle\\src\\Admin\\AbstractAdmin.php';
        include_once $this->targetDirs[3].'\\vendor\\sonata-project\\page-bundle\\src\\Admin\\SiteAdmin.php';
        include_once $this->targetDirs[3].'\\vendor\\sonata-project\\admin-bundle\\src\\Translator\\LabelTranslatorStrategyInterface.php';
        include_once $this->targetDirs[3].'\\vendor\\sonata-project\\admin-bundle\\src\\Translator\\UnderscoreLabelTranslatorStrategy.php';
        include_once $this->targetDirs[3].'\\vendor\\sonata-project\\admin-bundle\\src\\Security\\Handler\\SecurityHandlerInterface.php';
        include_once $this->targetDirs[3].'\\vendor\\sonata-project\\admin-bundle\\src\\Security\\Handler\\NoopSecurityHandler.php';

        $instance = new \Sonata\PageBundle\Admin\SiteAdmin('sonata.page.admin.site', 'Application\\Sonata\\PageBundle\\Entity\\Site', 'SonataPageBundle:SiteAdmin', ${($_ = isset($this->services['sonata.page.route.page.generator']) ? $this->services['sonata.page.route.page.generator'] : $this->load('getSonata_Page_Route_Page_GeneratorService.php')) && false ?: '_'});
        ...
        $instance->showMosaicButton(true);
        $instance->setTemplateRegistry(${($_ = isset($this->services['sonata.page.admin.site.template_registry']) ? $this->services['sonata.page.admin.site.template_registry'] : $this->load('getSonata_Page_Admin_Site_TemplateRegistryService.php')) && false ?: '_'});
        $instance->setSecurityInformation($this->parameters['sonata.admin.configuration.security.information']);
        $instance->initialize();
        $instance->addExtension(${($_ = isset($this->services['sonata.admin.event.extension']) ? $this->services['sonata.admin.event.extension'] : $this->load('getSonata_Admin_Event_ExtensionService.php')) && false ?: '_'});
    ...
    protected function getSonata_Page_Admin_SnapshotService()
    {
        ...
        $instance->showMosaicButton(true);
        $instance->setTemplateRegistry(${($_ = isset($this->services['sonata.page.admin.snapshot.template_registry']) ? $this->services['sonata.page.admin.snapshot.template_registry'] : $this->load('getSonata_Page_Admin_Snapshot_TemplateRegistryService.php')) && false ?: '_'});
        $instance->setSecurityInformation($this->parameters['sonata.admin.configuration.security.information']);
        $instance->initialize();
        $instance->addExtension(${($_ = isset($this->services['sonata.admin.event.extension']) ? $this->services['sonata.admin.event.extension'] : $this->load('getSonata_Admin_Event_ExtensionService.php')) && false ?: '_'});
    ...
    {
        return $this->services['sonata.page.manager.site'] = new \Sonata\PageBundle\Entity\SiteManager('Application\\Sonata\\PageBundle\\Entity\\Site', ${($_ = isset($this->services['doctrine']) ? $this->services['doctrine'] : $this->getDoctrineService()) && false ?: '_'});
    }
    ...
    {
        $this->services['sonata.page.page_service_manager'] = $instance = new \Sonata\PageBundle\Page\PageServiceManager(${($_ = isset($this->services['router']) ? $this->services['router'] : $this->getRouterService()) && false ?: '_'});

        $a = ${($_ = isset($this->services['sonata.page.service.default']) ? $this->services['sonata.page.service.default'] : $this->getSonata_Page_Service_DefaultService()) && false ?: '_'};
    ...
    {
        return $this->services['sonata.page.service.default'] = new \Sonata\PageBundle\Page\Service\DefaultPageService('Default', ${($_ = isset($this->services['sonata.page.template_manager']) ? $this->services['sonata.page.template_manager'] : $this->getSonata_Page_TemplateManagerService()) && false ?: '_'}, ${($_ = isset($this->services['sonata.seo.page.default']) ? $this->services['sonata.seo.page.default'] : $this->getSonata_Seo_Page_DefaultService()) && false ?: '_'});
    }
    ...
    {
        $this->services['sonata.page.template_manager'] = $instance = new \Sonata\PageBundle\Page\TemplateManager(${($_ = isset($this->services['sonata.templating']) ? $this->services['sonata.templating'] : $this->getSonata_TemplatingService()) && false ?: '_'}, array('error_codes' => array(404 => '_page_internal_error_not_found', 500 => '_page_internal_error_fatal')));

        $instance->setAll(array('default' => new \Sonata\PageBundle\Model\Template('default', '@SonataPage/layout.html.twig', array()), '2columns' => new \Sonata\PageBundle\Model\Template('2 columns layout', '@SonataPage/2columns_layout.html.twig', array())));
    ...
    protected function getSonata_Seo_Page_DefaultService()
    {
        ...
        $instance->setTitle('Project name');
    ...
    protected function getTwigService()
    {
        ...
        $f = ${($_ = isset($this->services['sonata.block.templating.helper']) ? $this->services['sonata.block.templating.helper'] : $this->getSonata_Block_Templating_HelperService()) && false ?: '_'};

        $g = new \Symfony\Bridge\Twig\Extension\HttpKernelExtension();
        ...
        $j->setDisplayOptions(array('maxStringLength' => 4096, 'fileLinkFormat' => $b));

        $k = new \Symfony\Bridge\Twig\AppVariable();
        $k->setEnvironment('dev');
        $k->setDebug(true);
        if ($this->has('security.token_storage')) {
            $k->setTokenStorage(${($_ = isset($this->services['security.token_storage']) ? $this->services['security.token_storage'] : $this->services['security.token_storage'] = new \Symfony\Component\Security\Core\Authentication\Token\Storage\TokenStorage()) && false ?: '_'});
        }
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\DumpExtension(${($_ = isset($this->services['var_dumper.cloner']) ? $this->services['var_dumper.cloner'] : $this->getVarDumper_ClonerService()) && false ?: '_'}, $h));
        ...
        $instance->addGlobal('sonata_block', ${($_ = isset($this->services['sonata.block.twig.global']) ? $this->services['sonata.block.twig.global'] : $this->services['sonata.block.twig.global'] = new \Sonata\BlockBundle\Twig\GlobalVariables(array('block_base' => '@SonataPage/Block/block_base.html.twig', 'block_container' => '@SonataPage/Block/block_container.html.twig'))) && false ?: '_'});
        ...
        $instance->addGlobal('sonata_page', ${($_ = isset($this->services['sonata.page.twig.global']) ? $this->services['sonata.page.twig.global'] : $this->services['sonata.page.twig.global'] = new \Sonata\PageBundle\Twig\GlobalVariables($this)) && false ?: '_'});
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('UieXbc10Sp', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('cwJJ-SwblT', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('H2i4mX8cPK', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addListener('kernel.request', array(0 => function () {
            return ${($_ = isset($this->services['sonata.page.site.selector.host']) ? $this->services['sonata.page.site.selector.host'] : $this->getSonata_Page_Site_Selector_HostService()) && false ?: '_'};
        }, 1 => 'onKernelRequest'), 47);
        $instance->addListener('kernel.request', array(0 => function () {
            return ${($_ = isset($this->services['sonata.page.site.selector.host']) ? $this->services['sonata.page.site.selector.host'] : $this->getSonata_Page_Site_Selector_HostService()) && false ?: '_'};
        }, 1 => 'onKernelRequestRedirect'), 0);
        $instance->addListener('kernel.response', array(0 => function () {
            return ${($_ = isset($this->services['sonata.page.response_listener']) ? $this->services['sonata.page.response_listener'] : $this->getSonata_Page_ResponseListenerService()) && false ?: '_'};
        }, 1 => 'onCoreResponse'), -1);
        $instance->addListener('kernel.request', array(0 => function () {
            return ${($_ = isset($this->services['sonata.page.request_listener']) ? $this->services['sonata.page.request_listener'] : $this->getSonata_Page_RequestListenerService()) && false ?: '_'};
        }, 1 => 'onCoreRequest'), 4);
        $instance->addListener('security.interactive_login', array(0 => function () {
            return ${($_ = isset($this->services['sonata.page.cms_manager_selector']) ? $this->services['sonata.page.cms_manager_selector'] : $this->services['sonata.page.cms_manager_selector'] = new \Sonata\PageBundle\CmsManager\CmsManagerSelector($this)) && false ?: '_'};
        }, 1 => 'onSecurityInteractiveLogin'), 0);
        $instance->addListener('kernel.exception', array(0 => function () {
            return ${($_ = isset($this->services['sonata.page.kernel.exception_listener']) ? $this->services['sonata.page.kernel.exception_listener'] : $this->load('getSonata_Page_Kernel_ExceptionListenerService.php')) && false ?: '_'};
        }, 1 => 'onKernelException'), -127);
    ...
    {
        return $this->services['sonata.block.loader.service'] = new \Sonata\BlockBundle\Block\Loader\ServiceLoader(array(0 => 'sonata.admin.block.admin_list', 1 => 'sonata.block.service.text', 2 => 'sonata.block.service.rss', 3 => 'sonata.user.block.menu', 4 => 'sonata.user.block.account', 5 => 'sonata.media.block.media', 6 => 'sonata.media.block.gallery', 7 => 'sonata.media.block.feature_media'));
    }
    ...
    {
        return $this->services['sonata.block.twig.global'] = new \Sonata\BlockBundle\Twig\GlobalVariables(array('block_base' => '@SonataPage/Block/block_base.html.twig', 'block_container' => '@SonataPage/Block/block_container.html.twig'));
    }
    ...
    {
        return $this->services['sonata.cache.recorder'] = new \Sonata\Cache\Invalidation\Recorder(${($_ = isset($this->services['sonata.cache.model_identifier']) ? $this->services['sonata.cache.model_identifier'] : $this->services['sonata.cache.model_identifier'] = new \Sonata\Cache\Invalidation\ModelCollectionIdentifiers(array())) && false ?: '_'});
    }
    ...
    /**
     * Gets the private 'sonata.page.block.context_manager' shared service.
     *
     * @return \Sonata\PageBundle\Block\BlockContextManager
     */
    protected function getSonata_Page_Block_ContextManagerService()
    {
        return $this->services['sonata.page.block.context_manager'] = new \Sonata\PageBundle\Block\BlockContextManager(${($_ = isset($this->services['sonata.block.loader.service']) ? $this->services['sonata.block.loader.service'] : $this->getSonata_Block_Loader_ServiceService()) && false ?: '_'}, ${($_ = isset($this->services['sonata.block.manager']) ? $this->services['sonata.block.manager'] : $this->getSonata_Block_ManagerService()) && false ?: '_'});
    }

    /**
     * Gets the private 'sonata.page.cache.js_async' shared service.
     *
     * @return \Sonata\PageBundle\Cache\BlockJsCache
     */
    protected function getSonata_Page_Cache_JsAsyncService()
    {
        return $this->services['sonata.page.cache.js_async'] = new \Sonata\PageBundle\Cache\BlockJsCache(${($_ = isset($this->services['router']) ? $this->services['router'] : $this->getRouterService()) && false ?: '_'}, ${($_ = isset($this->services['sonata.page.cms_manager_selector']) ? $this->services['sonata.page.cms_manager_selector'] : $this->services['sonata.page.cms_manager_selector'] = new \Sonata\PageBundle\CmsManager\CmsManagerSelector($this)) && false ?: '_'}, ${($_ = isset($this->services['sonata.block.renderer.default']) ? $this->services['sonata.block.renderer.default'] : $this->getSonata_Block_Renderer_DefaultService()) && false ?: '_'}, ${($_ = isset($this->services['sonata.page.block.context_manager']) ? $this->services['sonata.page.block.context_manager'] : $this->getSonata_Page_Block_ContextManagerService()) && false ?: '_'}, false);
    }

    /**
     * Gets the private 'sonata.page.cache.js_sync' shared service.
     *
     * @return \Sonata\PageBundle\Cache\BlockJsCache
     */
    protected function getSonata_Page_Cache_JsSyncService()
    {
        return $this->services['sonata.page.cache.js_sync'] = new \Sonata\PageBundle\Cache\BlockJsCache(${($_ = isset($this->services['router']) ? $this->services['router'] : $this->getRouterService()) && false ?: '_'}, ${($_ = isset($this->services['sonata.page.cms_manager_selector']) ? $this->services['sonata.page.cms_manager_selector'] : $this->services['sonata.page.cms_manager_selector'] = new \Sonata\PageBundle\CmsManager\CmsManagerSelector($this)) && false ?: '_'}, ${($_ = isset($this->services['sonata.block.renderer.default']) ? $this->services['sonata.block.renderer.default'] : $this->getSonata_Block_Renderer_DefaultService()) && false ?: '_'}, ${($_ = isset($this->services['sonata.page.block.context_manager']) ? $this->services['sonata.page.block.context_manager'] : $this->getSonata_Page_Block_ContextManagerService()) && false ?: '_'}, true);
    }

    /**
     * Gets the private 'sonata.page.decorator_strategy' shared service.
     *
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        })), new \Symfony\Component\Translation\Formatter\MessageFormatter(new \Symfony\Component\Translation\MessageSelector()), 'fr', array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yaml', 1 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => ($this->targetDirs[0].'/translations'), 'debug' => true, 'resource_files' => array('af' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.af.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.af.yml')), 'ar' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.ar.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.ar.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.ar.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\sonata-project\\core-bundle\\src/Resources/translations\\SonataCoreBundle.ar.xliff'), 4 => ($this->targetDirs[3].'\\vendor\\sonata-project\\admin-bundle\\src/Resources/translations\\SonataAdminBundle.ar.xliff'), 5 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.ar.yml'), 6 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.ar.yml')), 'az' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.az.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.az.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.az.xlf')), 'bg' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.bg.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.bg.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.bg.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\sonata-project\\core-bundle\\src/Resources/translations\\SonataCoreBundle.bg.xliff'), 4 => ($this->targetDirs[3].'\\vendor\\sonata-project\\admin-bundle\\src/Resources/translations\\SonataAdminBundle.bg.xliff'), 5 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.bg.yml'), 6 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.bg.yml'), 7 => ($this->targetDirs[3].'\\vendor\\sonata-project\\user-bundle\\src/Resources/translations\\SonataUserBundle.bg.xliff'), 8 => ($this->targetDirs[3].'\\vendor\\sonata-project\\page-bundle\\src/Resources/translations\\SonataPageBundle.bg.xliff')), 'ca' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.ca.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.ca.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.ca.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\sonata-project\\core-bundle\\src/Resources/translations\\SonataCoreBundle.ca.xliff'), 4 => ($this->targetDirs[3].'\\vendor\\sonata-project\\admin-bundle\\src/Resources/translations\\SonataAdminBundle.ca.xliff'), 5 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.ca.yml'), 6 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.ca.yml'), 7 => ($this->targetDirs[3].'\\vendor\\sonata-project\\user-bundle\\src/Resources/translations\\SonataUserBundle.ca.xliff')), 'cs' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.cs.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.cs.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.cs.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\sonata-project\\core-bundle\\src/Resources/translations\\SonataCoreBundle.cs.xliff'), 4 => ($this->targetDirs[3].'\\vendor\\sonata-project\\admin-bundle\\src/Resources/translations\\SonataAdminBundle.cs.xliff'), 5 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.cs.yml'), 6 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.cs.yml'), 7 => ($this->targetDirs[3].'\\vendor\\sonata-project\\user-bundle\\src/Resources/translations\\SonataUserBundle.cs.xliff'), 8 => ($this->targetDirs[3].'\\vendor\\sonata-project\\notification-bundle\\src/Resources/translations\\SonataNotificationBundle.cs.xliff')), 'cy' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.cy.xlf')), 'da' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.da.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.da.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.da.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.da.yml'), 4 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.da.yml')), 'de' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.de.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.de.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.de.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\sonata-project\\core-bundle\\src/Resources/translations\\SonataCoreBundle.de.xliff'), 4 => ($this->targetDirs[3].'\\vendor\\sonata-project\\block-bundle\\src/Resources/translations\\SonataBlockBundle.de.xliff'), 5 => ($this->targetDirs[3].'\\vendor\\sonata-project\\block-bundle\\src/Resources/translations\\validators.de.xliff'), 6 => ($this->targetDirs[3].'\\vendor\\sonata-project\\admin-bundle\\src/Resources/translations\\SonataAdminBundle.de.xliff'), 7 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.de.yml'), 8 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.de.yml'), 9 => ($this->targetDirs[3].'\\vendor\\sonata-project\\user-bundle\\src/Resources/translations\\SonataUserBundle.de.xliff'), 10 => ($this->targetDirs[3].'\\vendor\\sonata-project\\page-bundle\\src/Resources/translations\\SonataPageBundle.de.xliff'), 11 => ($this->targetDirs[3].'\\vendor\\sonata-project\\page-bundle\\src/Resources/translations\\validators.de.xliff'), 12 => ($this->targetDirs[3].'\\vendor\\sonata-project\\seo-bundle\\src/Resources/translations\\SonataSeoBundle.de.xliff'), 13 => ($this->targetDirs[3].'\\vendor\\sonata-project\\notification-bundle\\src/Resources/translations\\SonataNotificationBundle.de.xliff')), 'el' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.el.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.el.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.el.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.el.yml'), 4 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.el.yml')), 'en' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.en.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.en.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.en.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\sonata-project\\core-bundle\\src/Resources/translations\\SonataCoreBundle.en.xliff'), 4 => ($this->targetDirs[3].'\\vendor\\sonata-project\\block-bundle\\src/Resources/translations\\SonataBlockBundle.en.xliff'), 5 => ($this->targetDirs[3].'\\vendor\\sonata-project\\block-bundle\\src/Resources/translations\\validators.en.xliff'), 6 => ($this->targetDirs[3].'\\vendor\\sonata-project\\admin-bundle\\src/Resources/translations\\SonataAdminBundle.en.xliff'), 7 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.en.yml'), 8 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.en.yml'), 9 => ($this->targetDirs[3].'\\vendor\\sonata-project\\user-bundle\\src/Resources/translations\\SonataUserBundle.en.xliff'), 10 => ($this->targetDirs[3].'\\vendor\\sonata-project\\page-bundle\\src/Resources/translations\\SonataPageBundle.en.xliff'), 11 => ($this->targetDirs[3].'\\vendor\\sonata-project\\page-bundle\\src/Resources/translations\\validators.en.xliff'), 12 => ($this->targetDirs[3].'\\vendor\\sonata-project\\seo-bundle\\src/Resources/translations\\SonataSeoBundle.en.xliff'), 13 => ($this->targetDirs[3].'\\vendor\\sonata-project\\notification-bundle\\src/Resources/translations\\SonataNotificationBundle.en.xliff')), 'es' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.es.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.es.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.es.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\sonata-project\\core-bundle\\src/Resources/translations\\SonataCoreBundle.es.xliff'), 4 => ($this->targetDirs[3].'\\vendor\\sonata-project\\admin-bundle\\src/Resources/translations\\SonataAdminBundle.es.xliff'), 5 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.es.yml'), 6 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.es.yml'), 7 => ($this->targetDirs[3].'\\vendor\\sonata-project\\user-bundle\\src/Resources/translations\\SonataUserBundle.es.xliff'), 8 => ($this->targetDirs[3].'\\vendor\\sonata-project\\page-bundle\\src/Resources/translations\\SonataPageBundle.es.xliff'), 9 => ($this->targetDirs[3].'\\vendor\\sonata-project\\page-bundle\\src/Resources/translations\\validators.es.xliff'), 10 => ($this->targetDirs[3].'\\vendor\\sonata-project\\notification-bundle\\src/Resources/translations\\SonataNotificationBundle.es.xliff')), 'et' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.et.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.et.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.et.yml')), 'eu' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.eu.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.eu.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\sonata-project\\core-bundle\\src/Resources/translations\\SonataCoreBundle.eu.xliff'), 3 => ($this->targetDirs[3].'\\vendor\\sonata-project\\admin-bundle\\src/Resources/translations\\SonataAdminBundle.eu.xliff'), 4 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.eu.yml'), 5 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.eu.yml')), 'fa' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.fa.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.fa.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.fa.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\sonata-project\\core-bundle\\src/Resources/translations\\SonataCoreBundle.fa.xliff'), 4 => ($this->targetDirs[3].'\\vendor\\sonata-project\\admin-bundle\\src/Resources/translations\\SonataAdminBundle.fa.xliff'), 5 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.fa.yml'), 6 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.fa.yml'), 7 => ($this->targetDirs[3].'\\vendor\\sonata-project\\user-bundle\\src/Resources/translations\\SonataUserBundle.fa.xliff')), 'fi' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.fi.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.fi.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\sonata-project\\core-bundle\\src/Resources/translations\\SonataCoreBundle.fi.xliff'), 3 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.fi.yml'), 4 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.fi.yml'), 5 => ($this->targetDirs[3].'\\vendor\\sonata-project\\user-bundle\\src/Resources/translations\\SonataUserBundle.fi.xliff')), 'fr' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.fr.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.fr.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.fr.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\sonata-project\\core-bundle\\src/Resources/translations\\SonataCoreBundle.fr.xliff'), 4 => ($this->targetDirs[3].'\\vendor\\sonata-project\\block-bundle\\src/Resources/translations\\SonataBlockBundle.fr.xliff'), 5 => ($this->targetDirs[3].'\\vendor\\sonata-project\\block-bundle\\src/Resources/translations\\validators.fr.xliff'), 6 => ($this->targetDirs[3].'\\vendor\\sonata-project\\admin-bundle\\src/Resources/translations\\SonataAdminBundle.fr.xliff'), 7 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.fr.yml'), 8 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.fr.yml'), 9 => ($this->targetDirs[3].'\\vendor\\sonata-project\\user-bundle\\src/Resources/translations\\SonataUserBundle.fr.xliff'), 10 => ($this->targetDirs[3].'\\vendor\\sonata-project\\page-bundle\\src/Resources/translations\\SonataPageBundle.fr.xliff'), 11 => ($this->targetDirs[3].'\\vendor\\sonata-project\\page-bundle\\src/Resources/translations\\validators.fr.xliff'), 12 => ($this->targetDirs[3].'\\vendor\\sonata-project\\seo-bundle\\src/Resources/translations\\SonataSeoBundle.fr.xliff'), 13 => ($this->targetDirs[3].'\\vendor\\sonata-project\\notification-bundle\\src/Resources/translations\\SonataNotificationBundle.fr.xliff')), 'gl' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.gl.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.gl.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.gl.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.gl.yml')), 'he' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.he.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.he.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.he.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.he.yml'), 4 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.he.yml')), 'hr' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.hr.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.hr.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.hr.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\sonata-project\\core-bundle\\src/Resources/translations\\SonataCoreBundle.hr.xliff'), 4 => ($this->targetDirs[3].'\\vendor\\sonata-project\\admin-bundle\\src/Resources/translations\\SonataAdminBundle.hr.xliff'), 5 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.hr.yml'), 6 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.hr.yml'), 7 => ($this->targetDirs[3].'\\vendor\\sonata-project\\user-bundle\\src/Resources/translations\\SonataUserBundle.hr.xliff')), 'hu' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.hu.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.hu.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.hu.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\sonata-project\\core-bundle\\src/Resources/translations\\SonataCoreBundle.hu.xliff'), 4 => ($this->targetDirs[3].'\\vendor\\sonata-project\\block-bundle\\src/Resources/translations\\SonataBlockBundle.hu.xliff'), 5 => ($this->targetDirs[3].'\\vendor\\sonata-project\\admin-bundle\\src/Resources/translations\\SonataAdminBundle.hu.xliff'), 6 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.hu.yml'), 7 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.hu.yml'), 8 => ($this->targetDirs[3].'\\vendor\\sonata-project\\user-bundle\\src/Resources/translations\\SonataUserBundle.hu.xliff'), 9 => ($this->targetDirs[3].'\\vendor\\sonata-project\\page-bundle\\src/Resources/translations\\SonataPageBundle.hu.xliff'), 10 => ($this->targetDirs[3].'\\vendor\\sonata-project\\page-bundle\\src/Resources/translations\\validators.hu.xliff')), 'hy' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.hy.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.hy.xlf')), 'id' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.id.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.id.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.id.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.id.yml'), 4 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.id.yml')), 'it' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.it.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.it.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.it.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\sonata-project\\core-bundle\\src/Resources/translations\\SonataCoreBundle.it.xliff'), 4 => ($this->targetDirs[3].'\\vendor\\sonata-project\\block-bundle\\src/Resources/translations\\SonataBlockBundle.it.xliff'), 5 => ($this->targetDirs[3].'\\vendor\\sonata-project\\admin-bundle\\src/Resources/translations\\SonataAdminBundle.it.xliff'), 6 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.it.yml'), 7 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.it.yml'), 8 => ($this->targetDirs[3].'\\vendor\\sonata-project\\user-bundle\\src/Resources/translations\\SonataUserBundle.it.xliff'), 9 => ($this->targetDirs[3].'\\vendor\\sonata-project\\page-bundle\\src/Resources/translations\\SonataPageBundle.it.xliff'), 10 => ($this->targetDirs[3].'\\vendor\\sonata-project\\page-bundle\\src/Resources/translations\\validators.it.xliff'), 11 => ($this->targetDirs[3].'\\vendor\\sonata-project\\seo-bundle\\src/Resources/translations\\SonataSeoBundle.it.xliff'), 12 => ($this->targetDirs[3].'\\vendor\\sonata-project\\notification-bundle\\src/Resources/translations\\SonataNotificationBundle.it.xliff')), 'ja' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.ja.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.ja.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.ja.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\sonata-project\\core-bundle\\src/Resources/translations\\SonataCoreBundle.ja.xliff'), 4 => ($this->targetDirs[3].'\\vendor\\sonata-project\\admin-bundle\\src/Resources/translations\\SonataAdminBundle.ja.xliff'), 5 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.ja.yml'), 6 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.ja.yml'), 7 => ($this->targetDirs[3].'\\vendor\\sonata-project\\user-bundle\\src/Resources/translations\\SonataUserBundle.ja.xliff'), 8 => ($this->targetDirs[3].'\\vendor\\sonata-project\\page-bundle\\src/Resources/translations\\SonataPageBundle.ja.xliff'), 9 => ($this->targetDirs[3].'\\vendor\\sonata-project\\page-bundle\\src/Resources/translations\\validators.ja.xliff')), 'lb' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.lb.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.lb.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.lb.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\sonata-project\\core-bundle\\src/Resources/translations\\SonataCoreBundle.lb.xliff'), 4 => ($this->targetDirs[3].'\\vendor\\sonata-project\\admin-bundle\\src/Resources/translations\\SonataAdminBundle.lb.xliff'), 5 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.lb.yml')), 'lt' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.lt.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.lt.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.lt.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\sonata-project\\core-bundle\\src/Resources/translations\\SonataCoreBundle.lt.xliff'), 4 => ($this->targetDirs[3].'\\vendor\\sonata-project\\admin-bundle\\src/Resources/translations\\SonataAdminBundle.lt.xliff'), 5 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.lt.yml'), 6 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.lt.yml'), 7 => ($this->targetDirs[3].'\\vendor\\sonata-project\\user-bundle\\src/Resources/translations\\SonataUserBundle.lt.xliff')), 'lv' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.lv.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.lv.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.lv.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\sonata-project\\admin-bundle\\src/Resources/translations\\SonataAdminBundle.lv.xliff'), 4 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.lv.yml'), 5 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.lv.yml')), 'mn' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.mn.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.mn.xlf')), 'nb' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.nb.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.nb.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.nb.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.nb.yml'), 4 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.nb.yml')), 'nl' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.nl.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.nl.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.nl.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\sonata-project\\core-bundle\\src/Resources/translations\\SonataCoreBundle.nl.xliff'), 4 => ($this->targetDirs[3].'\\vendor\\sonata-project\\admin-bundle\\src/Resources/translations\\SonataAdminBundle.nl.xliff'), 5 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.nl.yml'), 6 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.nl.yml'), 7 => ($this->targetDirs[3].'\\vendor\\sonata-project\\user-bundle\\src/Resources/translations\\SonataUserBundle.nl.xliff'), 8 => ($this->targetDirs[3].'\\vendor\\sonata-project\\page-bundle\\src/Resources/translations\\SonataPageBundle.nl.xliff'), 9 => ($this->targetDirs[3].'\\vendor\\sonata-project\\page-bundle\\src/Resources/translations\\validators.nl.xliff'), 10 => ($this->targetDirs[3].'\\vendor\\sonata-project\\seo-bundle\\src/Resources/translations\\SonataSeoBundle.nl.xliff'), 11 => ($this->targetDirs[3].'\\vendor\\sonata-project\\notification-bundle\\src/Resources/translations\\SonataNotificationBundle.nl.xliff')), 'nn' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.nn.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.nn.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.nn.xlf')), 'no' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.no.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.no.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.no.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\sonata-project\\admin-bundle\\src/Resources/translations\\SonataAdminBundle.no.xliff')), 'pl' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.pl.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.pl.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.pl.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\sonata-project\\core-bundle\\src/Resources/translations\\SonataCoreBundle.pl.xliff'), 4 => ($this->targetDirs[3].'\\vendor\\sonata-project\\admin-bundle\\src/Resources/translations\\SonataAdminBundle.pl.xliff'), 5 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.pl.yml'), 6 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.pl.yml'), 7 => ($this->targetDirs[3].'\\vendor\\sonata-project\\user-bundle\\src/Resources/translations\\SonataUserBundle.pl.xliff')), 'pt' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.pt.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.pt.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\sonata-project\\core-bundle\\src/Resources/translations\\SonataCoreBundle.pt.xliff'), 3 => ($this->targetDirs[3].'\\vendor\\sonata-project\\admin-bundle\\src/Resources/translations\\SonataAdminBundle.pt.xliff'), 4 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.pt.yml'), 5 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.pt.yml'), 6 => ($this->targetDirs[3].'\\vendor\\sonata-project\\user-bundle\\src/Resources/translations\\SonataUserBundle.pt.xliff')), 'pt_BR' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.pt_BR.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.pt_BR.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.pt_BR.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\sonata-project\\core-bundle\\src/Resources/translations\\SonataCoreBundle.pt_BR.xliff'), 4 => ($this->targetDirs[3].'\\vendor\\sonata-project\\admin-bundle\\src/Resources/translations\\SonataAdminBundle.pt_BR.xliff'), 5 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.pt_BR.yml'), 6 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.pt_BR.yml'), 7 => ($this->targetDirs[3].'\\vendor\\sonata-project\\user-bundle\\src/Resources/translations\\SonataUserBundle.pt_BR.xliff'), 8 => ($this->targetDirs[3].'\\vendor\\sonata-project\\page-bundle\\src/Resources/translations\\SonataPageBundle.pt_BR.xliff'), 9 => ($this->targetDirs[3].'\\vendor\\sonata-project\\page-bundle\\src/Resources/translations\\validators.pt_BR.xliff')), 'ro' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.ro.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.ro.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.ro.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\sonata-project\\core-bundle\\src/Resources/translations\\SonataCoreBundle.ro.xliff'), 4 => ($this->targetDirs[3].'\\vendor\\sonata-project\\admin-bundle\\src/Resources/translations\\SonataAdminBundle.ro.xliff'), 5 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.ro.yml'), 6 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.ro.yml'), 7 => ($this->targetDirs[3].'\\vendor\\sonata-project\\user-bundle\\src/Resources/translations\\SonataUserBundle.ro.xliff')), 'ru' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.ru.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.ru.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.ru.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\sonata-project\\core-bundle\\src/Resources/translations\\SonataCoreBundle.ru.xliff'), 4 => ($this->targetDirs[3].'\\vendor\\sonata-project\\block-bundle\\src/Resources/translations\\SonataBlockBundle.ru.xliff'), 5 => ($this->targetDirs[3].'\\vendor\\sonata-project\\admin-bundle\\src/Resources/translations\\SonataAdminBundle.ru.xliff'), 6 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.ru.yml'), 7 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.ru.yml'), 8 => ($this->targetDirs[3].'\\vendor\\sonata-project\\user-bundle\\src/Resources/translations\\FOSUserBundle.ru.xliff'), 9 => ($this->targetDirs[3].'\\vendor\\sonata-project\\user-bundle\\src/Resources/translations\\SonataUserBundle.ru.xliff'), 10 => ($this->targetDirs[3].'\\vendor\\sonata-project\\page-bundle\\src/Resources/translations\\SonataPageBundle.ru.xliff'), 11 => ($this->targetDirs[3].'\\vendor\\sonata-project\\page-bundle\\src/Resources/translations\\validators.ru.xliff'), 12 => ($this->targetDirs[3].'\\vendor\\sonata-project\\seo-bundle\\src/Resources/translations\\SonataSeoBundle.ru.xliff'), 13 => ($this->targetDirs[3].'\\vendor\\sonata-project\\notification-bundle\\src/Resources/translations\\SonataNotificationBundle.ru.xliff')), 'sk' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.sk.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.sk.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.sk.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\sonata-project\\core-bundle\\src/Resources/translations\\SonataCoreBundle.sk.xliff'), 4 => ($this->targetDirs[3].'\\vendor\\sonata-project\\admin-bundle\\src/Resources/translations\\SonataAdminBundle.sk.xliff'), 5 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.sk.yml'), 6 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.sk.yml'), 7 => ($this->targetDirs[3].'\\vendor\\sonata-project\\user-bundle\\src/Resources/translations\\SonataUserBundle.sk.xliff'), 8 => ($this->targetDirs[3].'\\vendor\\sonata-project\\page-bundle\\src/Resources/translations\\SonataPageBundle.sk.xliff'), 9 => ($this->targetDirs[3].'\\vendor\\sonata-project\\page-bundle\\src/Resources/translations\\validators.sk.xliff'), 10 => ($this->targetDirs[3].'\\vendor\\sonata-project\\notification-bundle\\src/Resources/translations\\SonataNotificationBundle.sk.xliff')), 'sl' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.sl.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.sl.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.sl.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\sonata-project\\core-bundle\\src/Resources/translations\\SonataCoreBundle.sl.xliff'), 4 => ($this->targetDirs[3].'\\vendor\\sonata-project\\admin-bundle\\src/Resources/translations\\SonataAdminBundle.sl.xliff'), 5 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.sl.yml'), 6 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.sl.yml'), 7 => ($this->targetDirs[3].'\\vendor\\sonata-project\\user-bundle\\src/Resources/translations\\SonataUserBundle.sl.xliff'), 8 => ($this->targetDirs[3].'\\vendor\\sonata-project\\page-bundle\\src/Resources/translations\\SonataPageBundle.sl.xliff'), 9 => ($this->targetDirs[3].'\\vendor\\sonata-project\\page-bundle\\src/Resources/translations\\validators.sl.xliff'), 10 => ($this->targetDirs[3].'\\vendor\\sonata-project\\notification-bundle\\src/Resources/translations\\SonataNotificationBundle.sl.xliff')), 'sq' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.sq.xlf')), 'sr_Cyrl' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.sr_Cyrl.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.sr_Cyrl.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.sr_Cyrl.xlf')), 'sr_Latn' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.sr_Latn.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.sr_Latn.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.sr_Latn.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.sr_Latn.yml'), 4 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.sr_Latn.yml')), 'sv' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.sv.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.sv.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.sv.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.sv.yml'), 4 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.sv.yml')), 'th' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.th.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.th.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.th.yml'), 3 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.th.yml')), 'tl' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.tl.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.tl.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.tl.xlf')), 'tr' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.tr.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.tr.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\sonata-project\\admin-bundle\\src/Resources/translations\\SonataAdminBundle.tr.xliff'), 3 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.tr.yml'), 4 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.tr.yml')), 'uk' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.uk.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.uk.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\sonata-project\\core-bundle\\src/Resources/translations\\SonataCoreBundle.uk.xliff'), 3 => ($this->targetDirs[3].'\\vendor\\sonata-project\\admin-bundle\\src/Resources/translations\\SonataAdminBundle.uk.xliff'), 4 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.uk.yml'), 5 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.uk.yml'), 6 => ($this->targetDirs[3].'\\vendor\\sonata-project\\user-bundle\\src/Resources/translations\\SonataUserBundle.uk.xliff')), 'vi' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.vi.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.vi.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.vi.yml'), 3 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.vi.yml')), 'zh_CN' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.zh_CN.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.zh_CN.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.zh_CN.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\sonata-project\\core-bundle\\src/Resources/translations\\SonataCoreBundle.zh_CN.xliff'), 4 => ($this->targetDirs[3].'\\vendor\\sonata-project\\admin-bundle\\src/Resources/translations\\SonataAdminBundle.zh_CN.xliff'), 5 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.zh_CN.yml'), 6 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.zh_CN.yml')), 'zh_TW' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.zh_TW.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\sonata-project\\user-bundle\\src/Resources/translations\\SonataUserBundle.zh_TW.xliff')), 'pt_PT' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.pt_PT.xlf')), 'ua' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.ua.xlf')), 'sv_SE' => array(0 => ($this->targetDirs[3].'\\vendor\\sonata-project\\admin-bundle\\src/Resources/translations\\SonataAdminBundle.sv_SE.xliff')), 'bn' => array(0 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.bn.yml'), 1 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.bn.yml')), 'bn_BD' => array(0 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.bn_BD.yml'), 1 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.bn_BD.yml')), 'eo' => array(0 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.eo.yml'), 1 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.eo.yml')), 'ky' => array(0 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.ky.yml'), 1 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.ky.yml')))));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\vendor\\sonata-project\\page-bundle\\src/Resources/views'), 'SonataPage');
        $instance->addPath(($this->targetDirs[3].'\\vendor\\sonata-project\\page-bundle\\src/Resources/views'), '!SonataPage');
    ...
    protected function getValidator_ValidatorFactoryService()
    {
        ...
        }, 'Sonata\\PageBundle\\Validator\\UniqueUrlValidator' => function () {
            return ${($_ = isset($this->services['sonata.page.validator.unique_url']) ? $this->services['sonata.page.validator.unique_url'] : $this->load('getSonata_Page_Validator_UniqueUrlService.php')) && false ?: '_'};
        ...
        }, 'sonata.page.validator.unique_url' => function () {
            return ${($_ = isset($this->services['sonata.page.validator.unique_url']) ? $this->services['sonata.page.validator.unique_url'] : $this->load('getSonata_Page_Validator_UniqueUrlService.php')) && false ?: '_'};
        ...
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'SonataPageBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\vendor\\sonata-project\\page-bundle\\src'),
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_port' => NULL,
            'database_name' => 'viabox',
            'database_user' => 'root',
            'database_password' => NULL,
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => 'contact@viabox.fr',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'contact@viabox.fr',
            ...
            'assetic.bundles' => array(
                ...
                16 => 'SonataUserBundle',
                17 => 'ApplicationSonataUserBundle',
                18 => 'SonataPageBundle',
                19 => 'SonataSeoBundle',
                20 => 'SonataCacheBundle',
                21 => 'SonataNotificationBundle',
                22 => 'ApplicationSonataPageBundle',
                23 => 'DebugBundle',
            ...
            'fos_user.registration.confirmation.from_email' => array(
                'contact@viabox.fr' => 'contact@viabox.fr',
            ),
            ...
            'sonata.page.slugify_service' => 'sonata.core.slugify.cocur',
            'sonata.page.skip_redirection' => false,
            ...
            'sonata.page.router_auto_register.enabled' => false,
            'sonata.page.router_auto_register.priority' => 150,
            ...
            'console.command.ids' => array(
                ...
                'console.command.sonata_pagebundle_command_cleanupsnapshotscommand' => 'Sonata\\PageBundle\\Command\\CleanupSnapshotsCommand',
                'console.command.sonata_pagebundle_command_clonesitecommand' => 'Sonata\\PageBundle\\Command\\CloneSiteCommand',
                'console.command.sonata_pagebundle_command_createblockcontainercommand' => 'Sonata\\PageBundle\\Command\\CreateBlockContainerCommand',
                'console.command.sonata_pagebundle_command_createsitecommand' => 'Sonata\\PageBundle\\Command\\CreateSiteCommand',
                'console.command.sonata_pagebundle_command_createsnapshotscommand' => 'Sonata\\PageBundle\\Command\\CreateSnapshotsCommand',
                'console.command.sonata_pagebundle_command_dumppagecommand' => 'Sonata\\PageBundle\\Command\\DumpPageCommand',
                'console.command.sonata_pagebundle_command_migrateblocknamesettingcommand' => 'Sonata\\PageBundle\\Command\\MigrateBlockNameSettingCommand',
                'console.command.sonata_pagebundle_command_migratetojsontypecommand' => 'Sonata\\PageBundle\\Command\\MigrateToJsonTypeCommand',
                'console.command.sonata_pagebundle_command_renderblockcommand' => 'Sonata\\PageBundle\\Command\\RenderBlockCommand',
                'console.command.sonata_pagebundle_command_updatecoreroutescommand' => 'Sonata\\PageBundle\\Command\\UpdateCoreRoutesCommand',
            ...
            'sonata.core.form.types' => array(
                ...
                40 => 'sonata.user.form.roles_matrix_type',
                41 => 'sonata.user.form.gender_list',
                42 => 'sonata.page.form.type.page_selector',
                43 => 'sonata.page.form.create_snapshot',
                44 => 'sonata.page.form.template_choice',
                45 => 'sonata.page.form.page_type_choice',
            ),
